...
export const StepReceiveStakingFooter = (props: StepProps) => {
  ...
  // @ts-expect-error FIXME: during our coin rework, we need to confirm this: i can't find a single case where provider is set
  const providerName = (action && "provider" in action && action?.provider?.name) || "Ledger";
